...
import type { VetCase, Species, Sex, TaskStatus } from '../../types/case';
...
export default function NewCaseForm({ onClose, onSuccess }: NewCaseFormProps) {
    ...
    const handleParseAndFill = () => {
        ...
        setForm((f) => ({
            ...
            ...(parsed.arrivalDate !== undefined && { arrivalDate: parsed.arrivalDate }),
            ...(parsed.petName !== undefined && { petName: parsed.petName }),
            ...(parsed.ownerLastName !== undefined && { ownerLastName: parsed.ownerLastName }),
            ...
            ...(parsed.presentingComplaint !== undefined && { presentingComplaint: parsed.presentingComplaint }),
            ...(parsed.notes !== undefined && { notes: parsed.notes }),
        }));
        const filledFields = Object.keys(parsed).length;
        setParseMsg(filledFields > 0 ? `✓ Filled ${filledFields} field${filledFields !== 1 ? 's' : ''}` : 'No fields detected');
                ...
                <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-xl p-3 border border-gray-200">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Quick Fill from Text</span>
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    <svg className={`w-3.5 h-3.5 ${isListening ? 'animate-pulse' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        ...
                        />
                        {parseMsg && (
                            <p className="text-xs text-blue-600 font-medium mt-1">{parseMsg}</p>
                        )}
                    </div>
                    ...
                    <form onSubmit={handleSubmit} id="new-case-form">
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="col-span-1">
                                <label className="field-label block mb-1">MRN *</label>
                                <input
                                    type="text"
                                    value={form.mrn}
                            ...
                            {/* Pet Name */}
                            <div className="col-span-1">
                                <label className="field-label block mb-1">Pet Name *</label>
                                <input
                                    ref={petNameRef}
                                    type="text"
                                    value={form.petName}
                            ...
                            {/* Owner Last Name */}
                            <div className="col-span-1">
                                <label className="field-label block mb-1">Owner Last Name</label>
                                <input
                                    type="text"
                            ...
                            {/* Species */}
                            <div className="col-span-1">
                                <label className="field-label block mb-1">Species</label>
                                <select
                                    value={form.species}
                            ...
                            {/* Breed */}
                            <div className="col-span-1">
                                <label className="field-label block mb-1">Breed</label>
                                <input
                                    type="text"
                                    value={form.breed}
                            ...
                            {/* Sex */}
                            <div className="col-span-1">
                                <label className="field-label block mb-1">Sex</label>
                                <select
                                    value={form.sex}
                            ...
                            <div className="col-span-2">
                                <label className="field-label block mb-1">Presenting Complaint</label>
                                <textarea
                                    value={form.presentingComplaint}
                                    onChange={(e) => setForm((f) => ({ ...f, presentingComplaint: e.target.value }))}
