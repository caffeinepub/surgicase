                ...
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-gray-900 text-base tracking-tight">SurgiCase</span>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {identity && (
                            <div className="flex items-center gap-2 ml-1">
                                {userName && (
                                    <span className="hidden md:block text-xs text-gray-500 font-medium">{userName}</span>
                                )}
                                <button
