...
export default function DateInput({ value, onChange, className = '', id, tabIndex }: DateInputProps) {
    ...
    const mmInvalid = mm.length === 2 && (parseInt(mm) < 1 || parseInt(mm) > 12);
    const ddInvalid = dd.length === 2 && (parseInt(dd) < 1 || parseInt(dd) > 31);
